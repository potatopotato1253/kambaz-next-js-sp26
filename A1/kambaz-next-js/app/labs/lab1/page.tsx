      ...
      <h3>HTML Examples</h3>
       ...
       <div id="wd-p-tag">
        ...
        <p id="wd-p-1">
          ...
          the text easier to read. Browsers ignore vertical white spaces and render all the text as 
       ...
       <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
            ...
            <li>2 servings of chocolate chips</li>
        </ol>
      ...
      <h5>Unordered List Tag</h5>
       ...
       <div id="wd-forms">
        ...
        <form id="wd-text-fields">
            ...
            <input type="text" placeholder="jdoe" id="wd-text-fields-username" /> <br />
